...
router.get('/api/procurements/report-maintenance/:id', [authWall(['sales']), paramsToBody(['count'], 'query'), bodyValidator(updateMaintenanceProcurementSchema)], updateDamage)
